...
public class TrappingRainWater {
     ...
     * 此时可以知道当前下标的左侧和右侧的最大值元素。这两个值可以决定当前下标上是否可以累积雨水，以及可以累积多少雨水。
     *
     * 3. 使用两个最大值中的较小的值（木桶原理，短板效应），减去当前下标的值。即为当前下标上的雨水量。
     * 如果计算出雨水量为负数，则表示当前下标上无法累积雨水，则记录为 0.
     *
     * 4. 重复 2~3 步骤，直到遍历到最后一个元素。
     *
     * @param height
     * @return
     */
